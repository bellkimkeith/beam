...
const Home = () => {
  ...
  return (
    <section className="flex flex-col size-full gap-10 text-white">
      <div className="h-72 w-full bg-gradient-to-r from-[#27374D] to-gray-700 rounded-xl bg-clip-padding backdrop-filter backdrop-blur-3xl bg-opacity-0 border-[0.3px] border-gray-900">
        <div className="flex h-full flex-col justify-between px-3 py-6 md:px-5 md:py-8 lg:p-11">
          <h2 className="glassmorphism max-w-64 rounded py-2 text-center text-base font-normal">
